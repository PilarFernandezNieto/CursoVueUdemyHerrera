<template>
  ...
  >
    <a
      ...
      href="#"
      class="flex items-center shrink-0 px-5 py-3 space-x-2 text-gray-600"
    >
      <svg
    ...
    <a
      rel="noopener noreferrer"
      href="#"
      class="flex items-center shrink-0 px-5 py-3 space-x-2 rounded-t-lg text-gray-900"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  <div v-if="!products" class="text-center h-125">
    <h1 class="text-xl">Cargando productos</h1>
    <p>Espere, por favor</p>
  </div>

  <ProductLlist v-else :products="products" />
  <ButtonPagination
...
import ProductLlist from '../../products/components/ProductLlist.vue';
